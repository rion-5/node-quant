<!-- src/routes/momentum/compute-data/+page.svelte -->
<script lang="ts">
...
<div class="p-4">
  <h2 class="text-2xl font-bold mb-4">Compute Momentum Data</h2>
  ...
  <!-- Data Table -->
  {#if data.momentumData && data.momentumData.length > 0}
  ...
  {:else}
    <p>No data available. Please compute using the form above.</p>
  {/if}
</div>